/********************************************************************************
! \file source/vector/mac_SP_CVxCV.s
!
! \brief  C-Callable multiply-and-accumulate of a complex vector and 
			a complex vector
! \author XingYuanyuan
! \date   05/30/2022

 HISTORY:
   05/30/2022 - original (XingYuanyuan)
...
#		addi			a0, a0, 4							# a0 = a0 + 4 , a0 is w_im
		...
		fmadd.s			fa1, ft3, ft1, fa1	
		nop
		flw.pm			ft0, a0,4	
		flw.pm			ft3, a1,4
		fmsub.s			fa0, ft1, ft2, fa0					   																			
		fmadd.s			fa1, ft0, ft2, fa1
		nop
		flw.pm			ft2, a1,4																					
		flw.pm			ft1, a0,4	
		   													# \if N 鈮� 0 , jump to LBB1_2
		LBB1_2: 												
		ret		

# exception handling 
.LBB1_4:
		fmv.w.x			fa1, zero							# fa1 = zero = 0
		fmv.s			fa0, fa1							# fa0 = fa1 = 0
		ret															# return 
...
.Lfunc_end1:
		.size			mac_SP_CVxCV, .Lfunc_end1-mac_SP_CVxCV
