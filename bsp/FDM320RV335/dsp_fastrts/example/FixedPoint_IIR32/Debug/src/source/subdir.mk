...
src/source/%.o: ../src/source/%.c
	...
	"D:\CodeCanvas_2406041022\riscv\llvm\bin\clang" -g -c --target=riscv32-unknown-elf -march=rv32imfc_xsc -mabi=ilp32f -mcmodel=medany -mcpu=springcore-rv32 -mllvm -enable-misched -mllvm -misched-topdown=true -ID:\CodeCanvas_2406041022\riscv\gnu-toolchain\lib\gcc\riscv32-unknown-elf\10.2.0\include -ID:\CodeCanvas_2406041022\riscv\gnu-toolchain\lib\gcc\riscv32-unknown-elf\10.2.0\include-fixed -ID:\CodeCanvas_2406041022\riscv\gnu-toolchain\riscv32-unknown-elf\include -ID:\CodeCanvas_2406041022\riscv\gnu-toolchain\riscv32-unknown-elf\include\c++\10.2.0 -ID:\CodeCanvas_2406041022\riscv\gnu-toolchain\riscv32-unknown-elf\include\c++\10.2.0\riscv32-unknown-elf -I"D:\FDMTEK_RV335\dsp_fastrts\example\FixedPoint_IIR32\src\include" -o "$@" "$<"
...
src/source/%.o: ../src/source/%.s
	...
	"D:\CodeCanvas_2406041022\riscv\llvm\bin\clang" -mllvm --rptb-enable-cb -g -c --target=riscv32-unknown-elf -march=rv32imfc_xsc -mabi=ilp32f -o "$@" "$<"
	@echo 'Finished building: $<'
	@echo ' '
