...
//#endif
volatile struct PIE_CTRL_REGS PieCtrlRegs __attribute__ ((section("PieCtrlRegsFile")));
...
//#endif
volatile struct PIE_VECT_TABLE PieVectTable __attribute__ ((section("PieVectTableFile")));
