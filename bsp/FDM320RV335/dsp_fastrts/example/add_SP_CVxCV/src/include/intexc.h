...
// interrupt number
#define INTERRUPT_NUM 98
#define INTERRUPT_USER_DEFINED_NUM 12
...
// member of the structure should equals INTERRUPT_NUM
...
typedef union {
	...
	TRAP_HANDLER arr[INTERRUPT_NUM + INTERRUPT_USER_DEFINED_NUM];
