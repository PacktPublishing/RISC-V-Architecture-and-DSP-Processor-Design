...
//
// TITLE:   RV335 eCAN Back-to-back transmission and reception in
//          SELF-TEST mode
//
// ASSUMPTIONS:
//
//    This program requires the RV335 header files.
//
...
// Original Author H.J.
//
// $TI Release: RV335 Header Files V1.01 $
...
// This function is found in RV335_ECan.c
   InitECanGpio();
