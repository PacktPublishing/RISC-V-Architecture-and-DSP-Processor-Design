...
#if SPRINGCORE_2204_ECANB
	InitECanb();
#endif // if SPRINGCORE_2204_ECANB
}
...
InitECana(void)
{
	...
	//
	// CPU_FRQ_150MHz is defined in RV335_Examples.h
	//
#if (CPU_FRQ_150MHZ)
	//
	...
	//
	// CPU_FRQ_100MHz is defined in RV335_Examples.h
	//
#if (CPU_FRQ_100MHZ)
	//
...
InitECanb(void)
{
	...
	//    ECanbShadow.CANBTC.bit.BRPREG = 2;
	//    ECanbShadow.CANBTC.bit.TSEG2REG = 1;
	//    ECanbShadow.CANBTC.bit.TSEG1REG = 3;
#endif
...
InitECana_SCC(void)
{
	...
	//
	// Configure eCAN for SCC mode - ()
	// SCC mode also enables time-stamping feature
	//
	ECanaShadow.CANMC.all = ECanaRegs.CANMC.all;
	...
	ECanaRegs.CANGAM.all = 0x80000F00;
	ECanaLAMRegs.LAM3.all = 0x800000F0;
	ECanaLAMRegs.LAM0.all = 0x8000000F;
...
InitECanb_SCC(void)
{
	...
	ECanbRegs.CANGAM.all = 0x80000F00;
	ECanbLAMRegs.LAM3.all = 0x800000F0;
	ECanbLAMRegs.LAM0.all = 0x8000000F;
