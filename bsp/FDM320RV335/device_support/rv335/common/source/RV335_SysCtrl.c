...
InitSysCtrl(void)
{
	...
	// RV335_PLLCR and RV335_DIVSEL are defined in RV335_Examples.h
	//
	InitPll(RV335_PLLCR,RV335_DIVSEL);
...
InitPeripheralClocks(void)
{
	...
	// to save on power.
	//
	// Note: not all peripherals are available on all RV335 derivates.
