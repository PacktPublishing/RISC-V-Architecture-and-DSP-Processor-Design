...
#ifndef RV335_GLOBALPROTOTYPES_H
#define RV335_GLOBALPROTOTYPES_H
...
#if SPRINGCORE_2204_ECANA
extern void InitECan(void);
extern void InitECan_SCC(void);
extern void InitECana(void);
extern void InitECana_SCC(void);
extern void InitECanGpio(void);
extern void InitECanaGpio(void);
#endif // endif SPRINGCORE_2204_ECANA
#if SPRINGCORE_2204_ECANB
extern void InitECanb(void);
extern void InitECanb_SCC(void);
extern void InitECanbGpio(void);
#endif // endif SPRINGCORE_2204_ECANB
extern void InitECap(void);
extern void InitECapGpio(void);
extern void InitECap1Gpio(void);
extern void InitECap2Gpio(void);
#if SPRINGCORE_2204_ECAP3
extern void InitECap3Gpio(void);
#endif // endif SPRINGCORE_2204_ECAP3
#if SPRINGCORE_2204_ECAP4
extern void InitECap4Gpio(void);
#endif // endif SPRINGCORE_2204_ECAP4
#if SPRINGCORE_2204_ECAP5
extern void InitECap5Gpio(void);
#endif // endif SPRINGCORE_2204_ECAP5
#if SPRINGCORE_2204_ECAP6
extern void InitECap6Gpio(void);
#endif // endif SPRINGCORE_2204_ECAP6
extern void InitEPwm(void);
extern void InitEPwmGpio(void);
extern void InitEPwm1Gpio(void);
extern void InitEPwm2Gpio(void);
extern void InitEPwm3Gpio(void);
#if SPRINGCORE_2204_EPWM4
extern void InitEPwm4Gpio(void);
#endif // endif SPRINGCORE_2204_EPWM4
#if SPRINGCORE_2204_EPWM5
extern void InitEPwm5Gpio(void);
#endif // endif SPRINGCORE_2204_EPWM5
#if SPRINGCORE_2204_EPWM6
extern void InitEPwm6Gpio(void);
#endif // endif SPRINGCORE_2204_EPWM6
#if SPRINGCORE_2204_EQEP1
extern void InitEQep(void);
extern void InitEQepGpio(void);
extern void InitEQep1Gpio(void);
#endif // if SPRINGCORE_2204_EQEP1
#if SPRINGCORE_2204_EQEP2
extern void InitEQep2Gpio(void);
#endif // endif SPRINGCORE_2204_EQEP2
...
#endif // endif SPRINGCORE_2204_MCBSPB
...
#endif // endif SPRINGCORE_2204_SCIB
#if SPRINGCORE_2204_SCIC
extern void InitScicGpio(void);
#endif // endif SPRINGCORE_2204_SCIC
...
// examples will use these to relocate code from one LOAD location
...
#endif   // - end of RV335_GLOBALPROTOTYPES_H
