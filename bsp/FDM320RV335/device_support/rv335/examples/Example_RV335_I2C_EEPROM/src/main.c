...
int main(void)
{
	...
	IntVectTable.st.I2CINT1A = &i2c_int1a_isr;
	//
	...
	//
	enable_interrupt( GET_INT_NUM(IntVectTable.st.I2CINT1A));
...
I2CA_Init(void)
{
	...
	I2caRegs.I2CFFTX.all = 0x6064;	// Enable FIFO mode
	I2caRegs.I2CFFRX.all = 0x2064;	// Enable RXFIFO
